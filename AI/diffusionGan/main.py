...
# 加载数据集
train_dataset = IRVisibleDataset("path_to_ir_images", "path_to_visible_images", transform)
# 修改为实际的路径
train_dataset = IRVisibleDataset("/path/to/ir_images", "/path/to/visible_images", transform)
